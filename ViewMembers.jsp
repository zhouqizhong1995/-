...
<%
	...
	try{
		...
		%>
			<TR class= "row_even">
			<td align="left" colspan=2><B>注册ID: </B><%=RegID%></td><td align="left" colspan=2><a href ="Block.jsp?UserID=<%=UserID%>&RegID=<%=RegID%>"><IMG SRC="Images/Block.jpg" WIDTH="113" HEIGHT="26" BORDER="0" ALT=""></a></td></tr>
