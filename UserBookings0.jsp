...
<%
	...
	try{
		...
		%>
			<TR class= "row_even">
			<td align="left" colspan=2><B>预定ID: </B><%=BookingID%></td><td align="left" colspan=2><a href ="CheckIn.jsp?ResortID=<%=ResortID%>&RoomID=<%=RoomID%>&RoomCharges=<%=RoomCharges%>&BookingStatus=<%=BookingStatus%>&BookingID=<%=BookingID%>"><IMG SRC="Images/CheckIn.jpg" WIDTH="167" HEIGHT="26" BORDER="0" ALT=""></a></td></tr>
